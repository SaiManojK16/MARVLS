      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-950">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <CardHeader>
                <div className="bg-black/10 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                  <Smartphone className="h-6 w-6 text-accent-foreground" />
                </div>
                <CardTitle className="text-accent-foreground">Interactive & collaborative learning</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            {[
              {
                ...
                description: "Visualize quantum computing concepts including superposition, entanglement, qubits, and trapped ions in AR.",
              ...
              },
              {
                ...
                description: "View molecular geometry, point groups, symmetry operations, and chemical reactions in 3D augmented reality.",
              ...
              },
              {
                ...
                description: "Visualize electric fields, magnetism, circuits, electromagnets, motors, generators, and optics in AR.",
              ...
              },
              {
                ...
                icon: <Cube className="h-6 w-6 text-primary" />,
                description: "Explore vectors, forces, momentum, projectiles, circular motion, torque, and simple harmonic motion in AR.",
                image: "/placeholder.svg?height=200&width=400&text=Physics+1",
              ...
              },
              {
                ...
                icon: <Cube className="h-6 w-6 text-secondary" />,
                description: "Visualize plasma physics concepts through interactive AR models with changeable variables.",
              ...
              },
              {
                name: "Chemistry ARMV",
                icon: <Cube className="h-6 w-6 text-accent" />,
                description: "Advanced chemistry visualization tool for molecular structures and reactions in augmented reality.",
        ...
        <div className="container">
          ...
          <div className="aspect-video max-w-4xl mx-auto bg-black/10 rounded-lg overflow-hidden relative animate-fade-in-up">
            <div className="absolute inset-0 flex items-center justify-center">
              <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 animate-pulse-subtle">
